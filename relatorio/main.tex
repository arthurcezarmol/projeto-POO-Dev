...
\usepackage{array} % Para opções de formatação de colunas
...
\textbf{Semana 1} - 15/09 - 19/09: criação do modelo do front-end.

\textbf{Semana 2} - 22/09 - 26/09: criação das classes do sistema.

\textbf{Semana 3} - 29/09 - 03/10: criação e população do banco de dados.

\textbf{Semana 4} - 06/10 - 10/10: aprimoramento do front-end.

\textbf{Semana 5} - 13/10 - 17/10: aprimoramento do back-end.

\textbf{Semana 6} - 20/10 - 24/10: aprimoramento do back-end.

\textbf{Semana 7} - 27/10 - 31/10: aprimoramento do back-end.

\textbf{Semana 8} - 03/11 - 07/11: aprimoramento do front-end.

\textbf{Semana 9} - 10/11 - 14/11: aprimoramento do front-end.

\textbf{Semana 10} - 17/11 - 21/11: conexão entre front-end, back-end e banco de dados.

\textbf{Semana 11} - 24/11 - 28/11: revisão geral e melhorias pontuais.

\textbf{Semana 12} - 01/12 - 03/12: entrega do projeto pronto.
...
\hline
\multicolumn{2}{|c|}{\textbf{Cronograma de Estudos}} & \textbf{Horário} & \textbf{Duração} \\
\hline
\textbf{Dia} & \textbf{Matéria} & & \\
\hline
Segunda & Matemática & 9:00 - 10:30 & 1h30 \\
\hline
Terça & Português & 14:00 - 15:00 & 1h00 \\
\hline
Quinta & Biologia & 16:00 - 17:00 & 1h00 \\
\hline
\end{tabular}
\end{center}
